...
export async function fetchFromYahoo(symbol, interval) {
...
export async function fetchCandles(symbol, interval, outputsize, source) {
  return source === 'yahoo'
    ? fetchFromYahoo(symbol, interval)
