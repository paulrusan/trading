...
// Standard Wilder Parabolic SAR: tracks an uptrend/downtrend, the SAR trails behind
// price and flips to the opposite side (using the trend's extreme point as the new
// SAR) once price crosses it.
...
// Wilder's Average Directional Index. +DM/-DM/TR are Wilder-smoothed (same running
// technique as computeATR above), DX = |+DI - -DI| / (+DI + -DI) * 100, and ADX is
// itself a Wilder-smoothed average of DX — so it needs 2*period bars before the
// first value, not period like the other oscillators here.
